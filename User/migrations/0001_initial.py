...
=======
# Generated by Django 4.1.7 on 2023-04-19 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.FloatField(blank=True, default=0.0, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
                ('count_rates', models.IntegerField(blank=True, default=0, null=True)),
                ('date_of_establishment', models.DateField(default=datetime.date(2023, 4, 20))),
